export const NusaGovernor_abi = [
  ...
  {
    inputs: [
      { internalType: "contract IVotes", name: "__token", type: "address" },
    ],
    name: "initialize",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  {
    inputs: [
      { internalType: "address[]", name: "__targets", type: "address[]" },
      { internalType: "uint256[]", name: "__values", type: "uint256[]" },
      { internalType: "bytes[]", name: "__calldatas", type: "bytes[]" },
      { internalType: "string", name: "__description", type: "string" },
    ],
    name: "proposeProgress",
    outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
    stateMutability: "nonpayable",
    type: "function",
  },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint8", name: "__vote", type: "uint8" },
    ],
    name: "voteProgress",
    outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
    stateMutability: "nonpayable",
